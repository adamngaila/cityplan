							...
							<div class="col-md-2">
								<div class="navbar navbar-inverse" role="banner">
									<nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
										...
										<li><a href="profile.html">Admin</a></li>
								...
								<div class="col-md-6">
									...
									<div class="row">
										...
										while($row = mysqli_fetch_array($resulu))
										{
											...
											<center><p style = "font-family: Lucida Fax;font-size: 13px;"><?php echo '<strong>PLOT NUMBER:</strong>	'; echo $row['plotno'];  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 13px;"><?php echo '<strong> UTAMBUZI:</strong>	'; echo $row['utambuzi'];  ?></p>
											...
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong>PLOT SIZE:</strong>	'; echo $row['plotsize']; echo' meter square';  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong> PLOT LOCATION:</strong>	'; echo $row['plotLocation'];  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong>EXISTING USE :</strong>	'; echo $row['existingUse'];  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong>PROPOSED USE:</strong>	'; echo $row['proposedUse'];  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong>ROAD ACCESS :</strong>	'; echo $row['roadAccess'];  ?></p>
											<p style = "font-family: Lucida Fax;font-size: 11px;"><?php echo '<strong>PROPOSED USE:</strong>	'; echo $row['proposedUse'];  ?></p>
