  <?php
  session_start();$dbHost     = "mwgmw3rs78pvwk4e.cbetxkdyhwsb.us-east-1.rds.amazonaws.com";
...
//$db = new mysqli($dbHost, $dbUsername, $dbPassword, $dbName);
  ...
  $pdf->ln(1);
  $qry = "SELECT * FROM customer WHERE customerID =  '$namba'or Fname = '$namba' or midname = '$namba'or CONCAT(Fname,' ',midname) = '$namba' ";
  ...
  $qry = "SELECT * FROM plot inner join neighbor on plotno = plotnu WHERE plotno = '$namba'or plotno = '$name'";
  $resul = mysqli_query($connect,$qry);
  ...
  $pdf->Cell(100,7,$row['utambuzi'],1,1);
  $pdf->ln(1);
  ...
  $pdf->Image($pic,164,140,33,47,'JPEG');
  $pdf->ln(1);
  $pdf->Cell(25,7,'Sehemu',0,0);
  $pdf->Cell(40,7, $row['plotLocation'],1,0);

  $pdf->Cell(35,7,'Jirani na barabara',0,0,'C',false);
  $pdf->Cell(50,7, $row['roadAccess'],1,1);
  $pdf->ln(1);
  ...
  $pdf->Cell(35,7,$row['existingUse'],1,0);
  ...
  $qry = "SELECT * FROM nyingine WHERE plotid = '$namba'or '$name'";
  $resul = mysqli_query($connect,$qry);
